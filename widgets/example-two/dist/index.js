...
function (_Component) {
  ...
  _createClass(MyComponent, [{
    ...
    value: function render() {
      return React__default.createElement("div", null, "Component listening for events:", React__default.createElement("div", null, React__default.createElement("h3", null, "Events:"), !this.state.events.length && React__default.createElement("div", null, "You need to click a button from a first component in \"Components communicating\" example to add new events"), this.state.events.map(function (event) {
        return React__default.createElement("div", {
          key: "key-".concat(event)
        }, event);
      })), React__default.createElement("div", null, React__default.createElement("h3", null, "Users:"), this.state.isLoading && React__default.createElement("span", null, "Loading..."), this.state.users.map(function (user) {
        return React__default.createElement("div", {
